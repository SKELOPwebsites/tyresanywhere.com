<template>
    ...
    >
        ...
        <div v-if="editable" class="space-x-0.5" :class="{'hidden': !editMode}">
            <select ref="widthEl" :value="width" class="bg-transparent border border-black rounded-sm w-12 text-center">
                <option v-for="width in widths" :value="width" v-text="width"></option>
            </select>
            <select ref="profileEl" :value="profile" class="bg-transparent border border-black rounded-sm w-10 text-center">
                <option v-for="profile in profiles" :value="profile" v-text="profile"></option>
            </select>
            <select ref="rimEl" :value="rim" class="bg-transparent border border-black rounded-sm w-10 text-center">
...
function saveEdit () {
    ...
    let size = { width: widthEl.value.value, profile: profileEl.value.value, rim: rimEl.value.value }
