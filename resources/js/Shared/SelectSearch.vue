        ...
        >
            <span class="inline-block w-full rounded-md shadow-sm">
                <button
                    ...
                    class="relative z-0 w-full py-2 pl-3 pr-10 mt-1 text-left transition duration-150 ease-in-out bg-white border border-gray-300 rounded-md cursor-default focus:outline-none focus:shadow-outline-blue focus:border-blue-300 text-sm sm:leading-5"
                    :class="{'border-b border-b-red-500': error}"
                >
