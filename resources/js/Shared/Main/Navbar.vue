<template>
    <nav class="select-none shadow-[0_0px_10px_0px_rgba(0,0,0,0.8)] bg-black relative flex items-center justify-start">
                                ...
                                <div class="flex flex-row m-0">
                                    ...
                                    <div class="lg:w-1/4 w-1/3 lg:ml-auto px-3">
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <a class="block text-sm w-full py-1 px-4 clear-both text-gray-800 hover:bg-gray-200" href="tel:07989606060">
                                                07989 606060
                                            </a>
                                        </div>
                                    </div>
        ...
        <div class="md:hidden block w-full flex items-center justify-center relative h-[3.5rem]">
            <a class="flex items-center color-anim" href="tel:07989 606060">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                </svg>
                <span class="text-xl">07989 606060</span>
            </a>
