<template>
    ...
    >
        ...
        <div class="w-full h-20 border-b border-gray-300 flex  items-center" @click="sideBarOpen = !sideBarOpen">
            <img v-if="sideBarOpen" class="w-52 mx-auto" src="/images/main/tyresanywhere.webp" alt="Tyres Anywhere">
            <img v-else class="w-14 mx-auto" src="/images/main/tyresanywhere-icon.webp" alt="Tyres Anywhere">
        </div>
        ...
        >
            ...
            >
                <div class="mb-4 px-4">
                    ...
                    <SidebarLink title="Configurations" href="/admin/config">
