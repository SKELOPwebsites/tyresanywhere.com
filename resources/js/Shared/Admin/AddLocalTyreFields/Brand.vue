<template>
    <div
        class="relative flex items-center justify-start border-gray-300 text-xs group"
    >
                ...
                >
                    <span class="inline-block w-full rounded-sm">
                        <button
                            ...
                            class="relative z-0 w-full pl-2 pr-8 text-left transition duration-150 ease-in-out bg-transparent border border-black rounded-md cursor-default focus:outline-none focus:shadow-outline-blue focus:border-blue-300 text-xs sm:leading-5"
                        >
                            ...
                            <input
                                ...
                                type="search"
                                class="w-full h-full bg-transparent form-control focus:outline-none"
                            />
